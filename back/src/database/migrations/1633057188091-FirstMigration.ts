...
export class FirstMigration1633057188091 implements MigrationInterface {
    name = 'FirstMigration1633057188091'

    public async up(queryRunner: QueryRunner): Promise<void> {
      await queryRunner.query('CREATE TABLE "posts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "file" character varying NOT NULL, "language" character varying NOT NULL, "description" character varying NOT NULL, "subject" character varying, "instructor" character varying, "like_count" integer NOT NULL, "date" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))')
